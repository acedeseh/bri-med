          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">HYOSUNG</h6>
                  ...
                  <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                      <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">HYOSUNG Evaluation Overview</h5>
                      </div>
                      <div>
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                ...
                <div class="container d-flex">              
                  <a class="btn btn-outline-secondary mx-3 mt-2 d-block mb-0 fs-3 ms-auto" href="{{ route('hyosung.create') }}" >Add</a>
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <form method="POST" action="{{ route('hyosung.destroy', $rcmall->id) }}">
                                          @csrf
                                          @method('DELETE')
...
<script>
  ...
  window.location.href = "{{ url('/hyosung/edit') }}/" + id;
}
</script>
