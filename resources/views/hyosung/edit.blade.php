    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4">Edit HYOSUNG Problem</h5>
                        <div class="card">
                            <div class="card-body">
                                <form id="updateSspp" method="post" action="{{ route('hyosung.update', $hyosung->id) }}">
                                    @csrf
                                    @method('PATCH')
                                    <div class="mb-3">
                                        <label for="branchCode" class="form-label" readonly>Branch Code</label>
                                        <input class="form-select" value="{{ $hyosung->branchcode }}" id="branchCode" name="branchcode" readonly>
                                        <div id="branchCodeError" class="text-danger"></div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="branchName" class="form-label" readonly>Branch Name</label>
                                        <input type="text" value="{{ $hyosung->branchname }}" class="form-control" id="branchName" name="branchname" readonly>
                                    </div>
                                    <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label" readonly>Problem</label>
                                      <input type="text" value="{{ $hyosung->problem }}" class="form-control" name="problem">
                                  </div>
                                  <div class="mb-3">
                                      <label for="dateFound" class="form-label" readonly >Date Found</label>
                                      <input type="text" value="{{ $hyosung->date_found }}" class="form-control" id="dateFound" name="date_found">
                                  </div>
                                  <div class="mb-3">
                                      <label for="slaTarget" class="form-label" readonly >SLA Target</label>
                                      <input type="text" class="form-control" value="{{ $hyosung->sla_target }}" id="slaTarget" name="sla_target" readonly>
                                  </div>
                                  <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                      ...
                                      <input type="text" value="{{ $hyosung->analysis }}" class="form-control" name="analysis">
                                  </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Status">
                                        <input type="radio" class="btn-check" name="status" id="statusOnProgress" autocomplete="off"
                                            value="On Progress" {{ $hyosung->status == 'On Progress' ? 'checked' : '' }}>
                                        ...
                                        <input type="radio" class="btn-check" name="status" id="statusDone" autocomplete="off"
                                            value="Done" {{ $hyosung->status == 'Done' ? 'checked' : '' }}>
                                ...
                                <div class="mb-3" id="dateDoneContainer" style="display: none;">
                                    ...
                                    <input type="datetime-local" value="{{ $hyosung->date_done }}" class="form-control" name="date_done">
                                </div>

                                  <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">Note</label>
                                      <input type="text" value="{{ $hyosung->note }}" class="form-control" name="note">
                                  </div>
