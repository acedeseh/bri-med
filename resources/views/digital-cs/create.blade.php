              ...
              <div class="card">
                <div class="card-body">
                  <form id="inputDigitalCS">
                    ...
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Date Found</label>
                      <input type="date" class="form-control" >
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Date Process</label>
                      <input type="date" class="form-control" >
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Date Done</label>
                      <input type="date" class="form-control" >
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label" disabled>SLA</label>
                      <input type="text" class="form-control" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" value="Not Done (On Progress)" readonly >
                    </div>
                    <div class="mb-3">
